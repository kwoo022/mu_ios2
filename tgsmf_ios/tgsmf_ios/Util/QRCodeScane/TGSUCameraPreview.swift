...
class TGSUCameraPreview: UIView {
    
    private var label:UILabel?
    
    var previewLayer: AVCaptureVideoPreviewLayer?
    var session = AVCaptureSession()
    weak var delegate: TGSUQrCodeCameraDelegate?
    ...
    func createSimulatorView(delegate: TGSUQrCodeCameraDelegate){
